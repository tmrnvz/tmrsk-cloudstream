...
class DunyaRadyolariProvider : MainAPI() {
    ...
    override suspend fun getMainPage(page: Int, request: MainPageRequest): HomePageResponse {
        ...
        return newHomePageResponse(listOf(
            HomePageList("🇹🇷 Türkiye Radyoları", turkey, isHorizontalImages = true),
    ...
    override suspend fun load(url: String): LoadResponse {
        ...
        route.station?.let { station ->
            ...
            return newLiveStreamLoadResponse(station.name, uniqueUrl, url) {
                posterUrl = station.logo.ifBlank { SYNQBRAND_POSTER }
                plot = "${route.country} radyo yayını"
        ...
        return newTvSeriesLoadResponse(
            ...
            plot = "Famelack açık veri kaynağındaki ${route.country} radyo istasyonları"
        }
    }
